...
- Print speed
- Compatibility with most materials and layer heights
...
[Replacement brass nozzles](https://www.amazon.com/s?k=MK8+brass+nozzle+0.4mm+pack) are cheap - keep a pack on hand.
...
[Hardened steel nozzles](https://www.amazon.com/s?k=hardened+steel+nozzle+0.4mm+3d+printer) cost more than brass but are essential if you print abrasive filaments regularly.
...
- **Print quality degrading** with no other obvious cause
- **Stringing increasing** despite retraction tuning
- **Under-extrusion** that persists after flow calibration
- **Partial clogs** that keep recurring after cleaning
- **Visible wear** on the nozzle tip (oval hole instead of round, worn flat tip)
...
3. Use a [nozzle wrench or 7mm socket](https://www.amazon.com/s?k=3d+printer+nozzle+wrench+socket) to unscrew the nozzle
...
[Nozzle cleaning needles](https://www.amazon.com/s?k=nozzle+cleaning+needle+0.4mm+3d+printer) can clear partial clogs by pushing debris through while at temperature.

### Nozzle Cleaning Filament

[Cleaning filament](https://www.amazon.com/s?k=3d+printer+nozzle+cleaning+filament) is designed to flush out old material and residue when changing filament types.

---

## Summary

- **Default:** 0.4mm brass nozzle for most printing
- **Abrasive materials:** Switch to hardened steel before printing carbon fibre, glow-in-the-dark, or metal-filled filaments
- **Want more speed:** Try 0.6mm
- **Want more detail:** Try 0.2mm
- **Replace when:** Quality degrades and cleaning doesn't fix it

Nozzles are cheap. Keeping a pack of [replacement brass nozzles](https://www.amazon.com/s?k=MK8+brass+nozzle+0.4mm+pack) and a [hardened steel nozzle](https://www.amazon.com/s?k=hardened+steel+nozzle+0.4mm+3d+printer) on hand means you're never stuck waiting for a delivery when a nozzle gives up.
