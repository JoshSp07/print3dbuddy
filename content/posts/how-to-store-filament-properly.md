...
- **Inconsistent extrusion** — gaps and under-extrusion
...
[Silica gel desiccant packs](https://www.amazon.com/s?k=silica+gel+desiccant+packets+reusable) are cheap and reusable — bake them at 120°C for a few hours to regenerate when they're saturated. Most change colour when full (orange to green, or blue to pink depending on the type).

### Dedicated Filament Storage Boxes

Purpose-built filament dry boxes are a step up:

- [eSUN eBOX Lite](https://www.amazon.com/s?k=eSUN+eBOX+filament+dryer) — dry box with built-in heating and humidity display. Keeps filament dry while printing.
- [Sunlu FilaDryer S2](https://www.amazon.com/s?k=Sunlu+FilaDryer+S2) — popular mid-range option with accurate temperature control
...
[Vacuum storage bags](https://www.amazon.com/s?k=vacuum+storage+bags+filament) remove air entirely. Excellent for long-term storage of spools you won't use for months.
...
- **Crackling or popping** from the hotend while printing (most reliable indicator)
- **Steam or vapour** visible at the nozzle
- **Surface bubbles** or rough texture on prints
- **More stringing** than usual from the same filament
- **Colour changes** — some filaments look duller when wet
...
A [food dehydrator](https://www.amazon.com/s?k=food+dehydrator+filament+drying) set to 45-50°C for PLA (65°C for PETG, 70-80°C for ABS/Nylon) works excellently. Most spools fit easily.
...
A [filament dryer box](https://www.amazon.com/s?k=filament+dryer+box+3d+printing) like the Sunlu S2 or eSUN eBOX does the same job as a food dehydrator but is designed specifically for filament — you can even print directly from some models while drying.
...
**Buy a hygrometer.** A [cheap digital hygrometer](https://www.amazon.com/s?k=digital+hygrometer+thermometer) (~£5) inside your storage box tells you the humidity level. Aim for below 15% RH.
