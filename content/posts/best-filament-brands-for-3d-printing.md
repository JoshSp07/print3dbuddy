...
## What Makes a Good Filament Brand?
...
**Colour and consistency.** Good filament looks the same from the outside of the spool to the inside. Colour shifts or cloudy/matte sections mid-spool suggest inconsistent production.

**Accurate labelling.** The spool weight should match what's on the box. Some cheap brands short-fill spools.

---

## Best Overall: Bambu Lab Filament

**[View on Amazon UK](https://www.amazon.co.uk/s?k=bambu+lab+filament+pla&tag=print3dbuddy2-21)**
...
**Best for:** Beginners, high-volume printing, anyone watching the budget. Their PETG is also very good for the price.

---

## Best Premium: Polymaker
...
**Best for:** Functional parts, anything where quality matters, specialty materials.

---

## Best for PETG: Sunlu PETG

**[View on Amazon UK](https://www.amazon.co.uk/s?k=sunlu+petg+filament&tag=print3dbuddy2-21)**
...
## Best for Silk/Shiny PLA: ERYONE Silk PLA
...
## Best for ABS/ASA: Polymaker ASA
...
**Best for:** Outdoor parts, high-temperature applications, functional parts that need UV resistance.

---

## Brands I've Had Problems With

Without naming and shaming specific budget brands: in general, anything under £10/kg from a brand you've never heard of is a gamble. The main problems I've experienced with cheap filament:

- Short-filled spools (listed as 1kg, actually 800g)
- Inconsistent diameter causing mid-print under-extrusion
- Poor vacuum packaging, filament already absorbing moisture in the bag
- Colour inconsistency, especially in dark colours

You can get lucky with no-name cheap filament. But when a cheap spool causes a failed 12-hour print, you've lost more in filament waste than you saved on the original purchase.

---

## One Practical Note

If you want to know exactly what a spool of filament will cost you per print before you buy, the [Filament Cost Calculator at tools.print3dbuddy.com](https://tools.print3dbuddy.com) works it out instantly from the spool price and weight. Useful for comparing whether a cheaper spool actually costs less per gram once you factor in the weight difference.

---

The short version: **eSUN PLA+** for budget, **Polymaker** when quality matters, **Bambu Lab** for consistent all-round performance. Start with one of those and you won't be troubleshooting filament problems.
